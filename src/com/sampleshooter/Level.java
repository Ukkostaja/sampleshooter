...
public class Level {
	...
	public int getTempo() {
		...
		System.out.println("Curr pos: " + current_position + ", Tempo: " + tempos.get(current_position).tempo);
	...
	public float getTempoDelay() {
		...
		return 60.0f * 1000.0f / (float)(getTempo()); 
	}
	...
	private void read(String name) {
		...
		try {
			...
			while(true) {
				...
				System.out.println("Load tempo: " + newStep.tempo);
		...
		System.out.println("Read: " + name + ", Steps: " + tempos.size());
	...
	public void step() {
		...
		if (current_position >= tempos.size()) {
			...
			current_position = 0;
			// FIXME!! THIS IS BAD. MAKE END-GAME IF WE RUN OUT OF STEPS
